...
function setup() {
  var canvas = createCanvas(594, 841); // the canvas size
  // this is what helps the canvas stay in the middle and goes with the css
  canvas.parent("canvasContainer")

  // Set drawer variable to a LineDrawer instance.
